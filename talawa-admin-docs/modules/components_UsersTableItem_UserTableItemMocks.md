...
[src/components/UsersTableItem/UserTableItemMocks.ts:6](https://github.com/AVtheking/talawa-admin/blob/2c36281/src/components/UsersTableItem/UserTableItemMocks.ts#L6)
